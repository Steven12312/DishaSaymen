...
<body>
    ...
    <div class="container">
        ...
        <section id="invitation">
            <div class="invitation-card fade-in">
                    ...
                    <div class="program-item active" >
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <div style="text-align: left;">
                                ...
                                <div style="font-size: 0.9rem; color: #666; font-weight: 600; margin-top: 3px;">5th September 2026</div>
                            </div>
                ...
                <div class="rsvp-form-container">
                    ...
                    <p data-i18n="rsvp_deadline" style="color: var(--secondary); font-weight: 600; margin-bottom: 30px; font-size: 0.95rem; letter-spacing: 0.5px;">Please RSVP by July 30th - we look forward to your response!</p>
                    <?php if ($guest): ?>
        ...
        <div class="family-cartoon-container fade-in">
            <img src="images/OG2.jpeg" alt="Family Photo">
    ...
    <script>
        const i18n = {
            en: {
                ...
                blessings: "With the blessings of our Grandparents<br><div style='display:flex;gap:15px;margin-top:10px;font-size:0.85rem;text-align:center'><div style='flex:1'><div style='font-size:0.7rem;letter-spacing:1px;color:var(--secondary);text-transform:uppercase;margin-bottom:4px'>Grandparents of Bride</div><strong>Mr. Babulal Arenja & Mrs. Geeta Arenja</strong><br><div style='height:6px'></div><strong>Mr. Narayan Dass Jagga & Mrs. Shaku Jagga</strong></div><div style='flex:1'><div style='font-size:0.7rem;letter-spacing:1px;color:var(--secondary);text-transform:uppercase;margin-bottom:4px'>Grandparents of Groom</div><strong>Late Sdr. Roshan Kapoor & Late Smt. Murti Kaur Kapoor</strong><br><div style='height:6px'></div><strong>Mr. Manor Singh Kapoor & Late Smt. Pushpa Kaur Kapoor</strong></div></div>",
                ...
                rsvp_deadline: "Please RSVP by July 30th, 2026 – we look forward to your response!",
            ...
            de: {
                ...
                blessings: "Mit dem Segen unserer Großeltern<br><div style='display:flex;gap:15px;margin-top:10px;font-size:0.85rem;text-align:center'><div style='flex:1'><div style='font-size:0.7rem;letter-spacing:1px;color:var(--secondary);text-transform:uppercase;margin-bottom:4px'>Großeltern der Braut</div><strong>Mr. Babulal Arenja & Mrs. Geeta Arenja</strong><br><div style='height:6px'></div><strong>Mr. Narayan Dass Jagga & Mrs. Shaku Jagga</strong></div><div style='flex:1'><div style='font-size:0.7rem;letter-spacing:1px;color:var(--secondary);text-transform:uppercase;margin-bottom:4px'>Großeltern des Bräutigams</div><strong>Late Sdr. Roshan Kapoor & Late Smt. Murti Kaur Kapoor</strong><br><div style='height:6px'></div><strong>Mr. Manor Singh Kapoor & Late Smt. Pushpa Kaur Kapoor</strong></div></div>",
                ...
                rsvp_deadline: "Wir bitten um Ihre Rückmeldung bis zum 30. Juli 2026 – wir freuen uns sehr auf Ihre Zusage!",
